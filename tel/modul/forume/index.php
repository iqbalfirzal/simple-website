<html>
<head>
	<title>Megono Development Forum</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="">MEGONO DEV FORUM</a>
            </div>
        ...
        <!-- /.container-fluid -->
			...
			<div class="container" style="margin:8% auto;">
				<div class="col-sm-4 col-md-3">
					...
					<p>All programming language can discuss here.</p>
				</div>
				 <div class="col-sm-5 col-md-4 pull-right">
                   <div class="row">
						...
						<form method="POST" class="form-signin" action="functions/register.php">
							...
							<input type="text" name="ver_code" placeholder="Enter code" class="form-control" required>  
							<input type="submit" value="Signup" name="signup" class="btn btn-success" style="width:100%;">
						</form>
				</div>
			</div>
		</div>
